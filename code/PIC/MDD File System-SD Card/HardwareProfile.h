...
/* SD Card definitions: Change these to fit your application when using
   an SD-card-based physical layer                                   */
	...
	//PM
    ...
    #elif defined (__PIC32MX__)
        // Registers for the SPI module you want to use
        //#define MDD_USE_SPI_1 //jbai
        #define MDD_USE_SPI_2 //jbai
        ...
        #define SPI_FREQUENCY			(20000000) //jbai (20000000)
            ...
            // Description: SD-SPI Chip Select Output bit
            #define SD_CS               LATBbits.LATB9 //PORTDbits.RD4 //jbai //LATBbits.LATB9
            // Description: SD-SPI Chip Select TRIS bit
            #define SD_CS_TRIS          TRISBbits.TRISB9 //TRISDbits.TRISD4 //jbai TRISBbits.TRISB9
            
            // Description: SD-SPI Card Detect Input bit
            #define SD_CD               1 //PORTDbits.RG7 //jbai PORTGbits.RG0
            // Description: SD-SPI Card Detect TRIS bit
            #define SD_CD_TRIS          TRISGbits.TRISG9 //jbai TRISGbits.TRISG0

            // Description: SD-SPI Write Protect Check Input bit
            #define SD_WE               0 // PORTGbits.RG9 //jbai PORTGbits.RG1
            // Description: SD-SPI Write Protect Check TRIS bit
            #define SD_WE_TRIS          TRISGbits.TRISG9 //jbai TRISGbits.TRISG1

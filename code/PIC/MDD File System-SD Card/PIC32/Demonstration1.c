...
int main (void)
{
   ...
   //Initialize the RTCC
   //jbai RtccInit();
   //jbai while(RtccGetClkStat()!=RTCC_CLK_ON);// wait for the SOSC to be actually running and RTCC to have its clock source
...
//   }
   ...
   //PORTD = 0x0001; //jbai
/*
   unsigned char giantBuf[3000];

   pointer = FSfopen ("testfile3", "r");
   if (pointer == NULL) {//PORTD = 0x00FF;
while(1);}

   if (FSfread (giantBuf, 1, 2112, pointer) != 2112)
     {//PORTD = 0x00FE;
while(1);}
...
// justin-debug
   ...
   sendFullScreenMessage(0, "Full Screen Message 0");
   sendFullScreenMessage(1, "Full Screen Message 1");
   sendFullScreenMessage(2, "Full Screen Message 2");

   // move text boxes
   sendText(0, "Textbox 0");
   sendText(1, "Textbox 1");
   sendText(2, "Textbox 2");
   sendText(3, "Textbox 3");

   // turn menu boxes
   sendText(4, "Textbox 4");
   sendText(5, "Textbox 5");
   sendText(6, "Textbox 6");


   sendText(7, "Textbox 7");
   sendText(8, "Textbox 8");
   sendText(9, "Textbox 9");
   sendText(10, "Textbox 10");
   sendText(11, "Textbox 11");
   sendText(12, "Textbox 12");

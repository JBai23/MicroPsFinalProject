...
// Summary: A macro to enable/disable the FSf// printf function.
// Description: The ALLOW_FSF// printf definition can be commented out to disable the FSf// printf function.  This will save code space.  Note that
//              if FSf// printf is enabled and the PIC18 architecture is used, integer promotions must be enabled in the Project->Build Options
//              menu.  Write operations must be enabled to use FSf// printf.
//#define ALLOW_FSF// printf
